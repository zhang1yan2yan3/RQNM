%% 第一个函数zoom
function [alphak,nf,ng]=zoom21(alpha0,alpha1,dk,xk,sigmaba,rhoba,epsiki,nf,ng,i,r,r1,n,d)
...
%     d2=sign((alpha1-alpha0,d)*(d1^2-(g1(xk+alpha0*dk)'*dk)*(g1(xk+alpha1*dk)'*dk)));
%     alphaj=alpha1-(alpha1+alpha0)*(g1(xk+alpha1*dk)'*dk+d2-d1)/(g1(xk+alpha1*dk)'*dk-g1(xk+alpha0*dk)'*dk+2*d2);
